namespace RosbridgeNet.RosbridgeClient.Common.Generics
{
    ...
    public abstract class RosSubscriberBase<TRosMessage> : RosTopicOperatorBase<TRosMessage>, IRosSubscriber<TRosMessage> where TRosMessage : class, new()
    {
        public RosSubscriberBase(IRosbridgeMessageDispatcher rosbridgeMessageDispatcher, string topic, string type) : base(rosbridgeMessageDispatcher, topic, type)
        {
